...
def main():
    ...
    print(os.path.join(config.main_path, '{}_full.csv'.format(config.dataset)))
    ...
    df.to_csv(os.path.join(
        config.main_path, '{}_full.csv'.format(config.dataset)), index=False)
    df_train.to_csv(os.path.join(
        config.main_path, '{}_train.csv'.format(config.dataset)), index=False)
    df_test.to_csv(os.path.join(
        config.main_path, '{}_test.csv'.format(config.dataset)), index=False)
