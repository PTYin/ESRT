...
#  python doc2vec_img2dict.py --img_feature_file "image_features_${dataset}.b" --dataset "${dataset}" --processed_path "/home/share/yinxiangkun/processed/cold_start/ordinary/${dataset}/"
  python preprocess.py --review_file "reviews_${dataset}_5.json.gz" --meta_file "meta_${dataset}.json.gz" --dataset "${dataset}" --processed_path "/home/share/yinxiangkun/processed/cold_start/ordinary/${dataset}/"
  python doc2vec.py --dataset "${dataset}" --processed_path "/home/share/yinxiangkun/processed/cold_start/ordinary/${dataset}/"
...
#    python doc2vec_img2dict.py --img_feature_file "image_features_${dataset}.b" --dataset "${dataset}" --processed_path "/home/share/yinxiangkun/processed/cold_start/user_${max_products}/${dataset}/"
    python preprocess.py --review_file "reviews_${dataset}_5.json.gz" --meta_file "meta_${dataset}.json.gz" --max_products_per_user ${max_products} --dataset "${dataset}" --processed_path "/home/share/yinxiangkun/processed/cold_start/user_${max_products}/${dataset}/"
    python doc2vec.py --dataset "${dataset}" --processed_path "/home/share/yinxiangkun/processed/cold_start/user_${max_products}/${dataset}/"
...
#    python doc2vec_img2dict.py --img_feature_file "image_features_${dataset}.b" --dataset "${dataset}" --processed_path "/home/share/yinxiangkun/processed/cold_start/product_${max_users}/${dataset}/"
    python preprocess.py --review_file "reviews_${dataset}_5.json.gz" --meta_file "meta_${dataset}.json.gz" --max_users_per_product ${max_users} --dataset "${dataset}" --processed_path "/home/share/yinxiangkun/processed/cold_start/product_${max_users}/${dataset}/"
    python doc2vec.py --dataset "${dataset}" --processed_path "/home/share/yinxiangkun/processed/cold_start/product_${max_users}/${dataset}/"
