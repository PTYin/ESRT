...
for (( i = 0; i < 4; i++ )); do
  ...
  for (( j = 0; j < 4; j++ )); do
    ...
    cp "/home/share/yinxiangkun/saved/${models[j]}_${embedding_size}_${dataset[i]}/test.bias_product.ranklist" "/home/share/yinxiangkun/saved/cold_start/${embedding_size}/${dataset[i]}/${models[j]}.ranklist"
